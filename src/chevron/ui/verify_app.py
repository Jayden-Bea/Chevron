...
def main(argv: list[str] | None = None) -> None:
    ...
    active_correspondences = editable_correspondences if use_edited_for_warp else correspondences
    ...
    for view in VIEW_NAMES:
        pairs = active_correspondences.get(view, {})
    ...
    if show_metrics:
        ...
        metrics = compute_reprojection_metrics(active_correspondences, homographies)
        if metrics:
            st.table(metrics)
        else:
